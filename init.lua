...
-- Show diagnostic messages inline (virtual text)
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap('n', '<leader>j', '<cmd>NvimTreeFocus<CR>', { noremap = true, silent = true })
    end,
  },
  {
  ...
  { -- Catppuccin colorscheme with Mocha flavor
    'catppuccin/nvim',
    name = 'catppuccin',
  ...
  { -- Rose Pine colorscheme (alternative)
